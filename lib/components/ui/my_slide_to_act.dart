...
class MySlideToAct extends StatefulWidget {
  final String text;
  ...
  @override
  State<MySlideToAct> createState() => _MySlideToActState();
}

class _MySlideToActState extends State<MySlideToAct> {
  double _position = 0;
...
// Example usage
class MySlideToActExample extends StatelessWidget {
